      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div className="lg:pl-12 lg:pt-4">
          <div className="lg:max-w-lg">
            <h2 className="md:text-xl text-lg font-bold leading-7 text-white">Market Insights</h2>
            <p className="mt-2 md:text-6xl font-bold flex justify-center items-center tracking-tight bg-gradient-to-r from-blue-400 to-purple-700 bg-clip-text text-transparent text-5xl">StockWatch</p>
